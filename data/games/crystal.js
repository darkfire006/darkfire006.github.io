let crystal = {
    ...
    warps: {
        ...
        puzzlechambers: {
			...
			hooh_bot:       {x: 80,  y: 146, corridor: "hooh_top",       name: "Puzzle (Ho-oh)"      },
			kabuto_top:     {x: 256, y: 25,  corridor: "kabuto_bot",     name: "Puzzle (Kabuto)"     },
			kabuto_bot:     {x: 256, y: 146, corridor: "kabuto_top",     name: "Puzzle (Kabuto)"     },
			omanyte_top:    {x: 80,  y: 194, corridor: "omanyte_bot",    name: "Puzzle (Omanyte)"    },
			omanyte_bot:    {x: 80,  y: 316, corridor: "omanyte_top",    name: "Puzzle (Omanyte)"    },
			aerodactyl_top: {x: 256, y: 194, corridor: "aerodactyl_bot", name: "Puzzle (Aerodactyl)" },
			aerodactyl_bot: {x: 256, y: 316, corridor: "aerodactyl_top", name: "Puzzle (Aerodactyl)" },
        ...
        lighthouse: {
			...
			f3_stairs_iso:{x: 164, y: 60, 							name: "Lighthouse (F3) Drop"  },
