let crystal = {
    ...
    locations: {
        // Cities
        newbark:		 {x: 123, y: 72, w: 8,  h: 8,  name: "New Bark Town" },
        ...
        celadon_r7:    {x: 195, y: 40,  w: 24, h: 8,  name: "Celadon City\nRoute 7/16"  },
        ...
        goldenrodstore:        {x: 43,  y: 56, w: 8, h: 8,  name: "Goldenrod\nDepartment Store"    },
        goldenrodelevator:     {x: 43,  y: 64, w: 8, h: 8,  name: "Goldenrod Dept.\nStore Elev."    },
        radiotower:			   {x: 27,  y: 64, w: 8, h: 8,  name: "Goldenrod\n Radio Tower"		   },
        underground:           {x: 43,  y: 72, w: 8, h: 8,  name: "Underground"                    },
        tintower:              {x: 51,  y: 8,  w: 8, h: 8,  name: "Tin Tower"                      },
        ...
        rockethq:			   {x: 91,  y: 24, w: 8, h: 8,  name: "Team Rocket HQ"			 	   },
        ...
        sabrina:         		{x: 235, y: 32, w: 8, h: 8,  name: "Saffron Gym"                 },
        ...
        celadonstore:          {x: 199, y: 32, w: 8, h: 8, name: "Celadon\nDepartment Store"       },
        celadonelevator:       {x: 207, y: 32, w: 8, h: 8, name: "Celadon Dept.\nStore Elev."       },
    ...
    warps: {
        ...
        newbark: {
			home:			{x: 216,	y: 90	},
			elmlab:			{x: 104,	y: 56	},
			elmhouse:		{x: 184,	y: 216	},
			house1:			{x: 56,		y: 184	},
			home_stairs:	{x: 312,	y: 168, corridor: "home_door", name: "Mom"     },
			home_door:		{x: 272,	y: 280, corridor: "home_stairs",   name: "Mom"     },
        },
        cherrygrove_r29: {
			r29_gate:	{x: 487, y: 78, name: "R29 (Cherrygrove)" },
			mart:		{x: 280, y: 80                            },
			center:		{x: 376, y: 36                            },
			house1:		{x: 182, y: 140                           },
			house2:		{x: 311, y: 170                           },
			house3:		{x: 408, y: 202                           },
			cave:		{x: 70, y: 112, name: "Cherrygrove (cave)" },
        },
        violet: {
            sprout:        {x: 383, y: 52                                                           },
			leftmart:      {x: 66,  y: 219                                                          },
        ...
        olivine_r40: {
			...
			dock:       {x: 316, y: 408, name: "Olivine City"       },
        ...
        indigo_e4: {
			indigo_top:		{x: 100, y: 440,	corridor: "indigo_bot",		name: "Indigo Plateau"    },
			indigo_bot:		{x: 100, y: 340,	corridor: "indigo_top",		name: "Indigo Plateau"    },
			center_ent:		{x: 220, y: 490,	corridor: "center_top",		name: "Indigo Plateau (center)"    },
			center_top:		{x: 269, y: 376,	corridor: "center_ent",		name: "Indigo Plateau (center)"    },
        ...
        pewter: {
			...
			center: {x: 222, y: 367 },
			bot:    {x: 121, y: 448 },
			center_in:    {x: 64, y: 380, corridor: "center_in", name: "Pewter Center (Trade)"      },
        },
        cerulean_r5: {
			candy:         {x: 59,  y: 174                                                         },
			robbed:        {x: 393, y: 213                                                         },
        ...
        lavender_r8: {
			...
			gate_added: {x: 166,  y: 100, name:"Route 8 (Lavender)" },
        },
        saffron: {
			topgate:   {x: 294, y: 23  },
        ...
        r34_ilex: {
			...
			dc_top:			{x: 120, y: 140, corridor: "dc_bot",  name: "Daycare" },
			dc_bot:			{x: 150, y: 200, corridor: "dc_top",  name: "Daycare" },
        },
        r35_r36: {
			botgate:    {x: 158, y: 452,                         name: "Route 35"          },
			botpark:    {x: 58,  y: 294,                         name: "Route 35"          },
			toppark:    {x: 303, y: 54,                          name: "Route 36 (Park)"          },
        ...
        puzzlechambers: {
			...
			hooh_hole:		{x: 80,  y: 56,  							 name: "Puzzle (Ho-oh)"      },
			hooh_bot:		{x: 80,  y: 146, 							 name: "Puzzle (Ho-oh)"      },
			kabuto_top:		{x: 256, y: 25,  							 name: "Puzzle (Kabuto)"     },
			kabuto_hole:	{x: 256,  y: 56,  							 name: "Puzzle (Kabuto)"      },
			kabuto_bot:		{x: 256, y: 146, 							 name: "Puzzle (Kabuto)"     },
			omanyte_top:	{x: 80,  y: 194, 							 name: "Puzzle (Omanyte)"    },
			omanyte_hole:	{x: 80,  y: 232, 							 name: "Puzzle (Omanyte)"    },
			omanyte_bot:	{x: 80,  y: 316, 							 name: "Puzzle (Omanyte)"    },
			aerodactyl_top:	{x: 256, y: 194, 							 name: "Puzzle (Aerodactyl)" },
			aerodactyl_hole:	{x: 256, y: 232,						 name: "Puzzle (Aerodactyl)" },
			aerodactyl_bot:	{x: 256, y: 316, 							 name: "Puzzle (Aerodactyl)" },
			alphmain:		{x: 168, y: 164, 							 name: "Ruins of Alph" },
			alphmain_nw:	{x: 134, y: 130, corridor: "alphmain_nw",	 name: "Ruins of Alph" },
			alphmain_ne:	{x: 200, y: 130, corridor: "alphmain_ne",	 name: "Ruins of Alph" },
			alphmain_sw:	{x: 134, y: 194, corridor: "alphmain_sw",	 name: "Ruins of Alph" },
			alphmain_se:	{x: 200, y: 194, corridor: "alphmain_se",	 name: "Ruins of Alph" },
        },
        unioncave: {
			...
			b1f_cor_left:	{x: 385, y: 500, corridor: "b1f_cor_right",	name: "Union Cave (B1F)" },
			b1f_cor_right:	{x: 600, y: 500, corridor: "b1f_cor_left",	name: "Union Cave (B1F)" },
			b2f:			{x: 164, y: 500, corridor: "b2f",			name: "Union Cave (B2F)" },
        },
        goldenrodstore: {
			f1_door: {x: 132, y: 380, name: "Goldenrod Store" },
			f1_door:	{x: 132,	y: 380, name: "Goldenrod Store" },
			f1_up:		{x: 252,	y: 270, name: "Goldenrod Store" },
			f1_el:		{x: 64,		y: 316, name: "Goldenrod Store" },
			f2_down:	{x: 252,	y: 134, name: "Goldenrod Store" },
			f2_up:		{x: 204,	y: 176, name: "Goldenrod Store" },
			f2_el:		{x: 64,		y: 176, name: "Goldenrod Store" },
			f3_up:		{x: 252,	y: -5,  name: "Goldenrod Store" },
			f3_down:	{x: 204,	y: 40,  name: "Goldenrod Store" },
			f3_el:		{x: 64,		y: 40,  name: "Goldenrod Store" },
			f4_down:	{x: 520,	y: 270, name: "Goldenrod Store" },
			f4_up:		{x: 470,	y: 316, name: "Goldenrod Store" },
			f4_el:		{x: 332,	y: 316, name: "Goldenrod Store" },
			f5_up:		{x: 520,	y: 134, name: "Goldenrod Store" },
			f5_down:	{x: 470,	y: 176, name: "Goldenrod Store" },
			f5_el:		{x: 332,	y: 176, name: "Goldenrod Store" },
			f6_down:	{x: 520,	y: -5,  name: "Goldenrod Store" },
			f6_up:		{x: 470,	y: 40,  name: "Goldenrod Store" },
			f6_el:		{x: 332,	y: 40,  name: "Goldenrod Store" },
			b1f_el:		{x: 266,	y: 487, name: "Goldenrod Store" },
			b1f_down:	{x: 389,	y: 487, name: "Goldenrod Store" },
        },
        goldenrodelevator: {
			gds_el_1f:	{x: 48,		y: 72, name: "Goldenrod Elev. (1F)" },
			gds_el_2f:	{x: 144,	y: 72, name: "Goldenrod Elev. (2F)" },
			gds_el_3f:	{x: 240,	y: 72, name: "Goldenrod Elev. (3F)" },
			gds_el_4f:	{x: 48,		y: 168, name: "Goldenrod Elev. (4F)" },
			gds_el_5f:	{x: 144,	y: 168, name: "Goldenrod Elev. (5F)" },
			gds_el_6f:	{x: 240,	y: 168, name: "Goldenrod Elev. (6F)" },
			gds_el_b1f:	{x: 144,	y: 264, name: "Goldenrod Elev. (B1F)" },
        },
        underground: {
			top:					{x: 31,  y: 72                                                   },
			basement:				{x: 264, y: 130                                                  },
			bot:					{x: 31,  y: 188                                                  },
			basement_rival_up:		{x: 148, y: 188, corridor: "basement_rival_door",		name: "Basement" },
			basement_rival_door:	{x: 148, y: 312, corridor: "basement_rival_up",			name: "Basement" },
			basement_director_up:	{x: 252, y: 204, corridor: "basement_director_door",	name: "Warehouse" },
			basement_director_door:	{x: 252, y: 344, corridor: "basement_director_up",		name: "Warehouse" },
        },
        radiotower: {
			rt_1f_door:			{x: 48,	 y: 640, corridor: "rt_1f_up",			name: "Radio Tower (1F)" },
			rt_1f_up:			{x: 248, y: 540, corridor: "rt_1f_door",		name: "Radio Tower (1F)" },
			rt_2f_down:			{x: 248, y: 400, corridor: "rt_2f_up",			name: "Radio Tower (2F)" },
			rt_2f_up:			{x: 16,	 y: 400, corridor: "rt_2f_down",		name: "Radio Tower (2F)" },
			rt_3f_down:			{x: 16,  y: 288,								name: "Radio Tower (3F)" },
			rt_3F_up_left:		{x: 120, y: 288,								name: "Radio Tower (3F)" },
			rt_3F_up_right:		{x: 272,  y: 288,								name: "Radio Tower (3F)" },
			rt_4f_left_down:	{x: 148, y: 112,	 corridor: "rt_4f_left_up",		name: "Radio Tower (4F)" },
			rt_4f_left_up:		{x: 16,	 y: 128,	 corridor: "rt_4f_left_down",	name: "Radio Tower (4F)" },
			rt_4f_right_down:	{x: 272, y: 128,	 corridor: "rt_4f_right_up",	name: "Radio Tower (4F)" },
			rt_4f_right_up:		{x: 200, y: 144,	 corridor: "rt_4f_right_down",	name: "Radio Tower (4F)" },
			rt_5f_director:		{x: 16,	 y: 16,	 corridor: "rt_5f_director",	name: "Radio Tower (5F)" },
			rt_5f_studio:		{x: 200, y: 16,	 corridor: "rt_5f_studio",		name: "Radio Tower (5F)" },
        },
        tintower: {
			f1_s:	{x: 130, y: 234, corridor: "f1_n",	name: "Tin Tower (1F)"	},
			f1_n:	{x: 130, y: 16, corridor: "f1_s",	name: "Tin Tower (1F)"	},
			...
			f6_w:  {x: 50,  y: 412, corridor: "f6_s",  name: "Tin Tower (6F)"     },
			f7_s:  {x: 396, y: 508,                    name: "Tin Tower (7F)"     },
			f7_w:  {x: 285, y: 416,                    name: "Tin Tower (7F)"     },
			f7_n:  {x: 365, y: 318,                    name: "Tin Tower (7F)"     },
			f8_n:  {x: 655, y: 317, corridor: "f8_e",  name: "Tin Tower (8F)"     },
			f8_e:  {x: 720, y: 381, corridor: "f8_n",  name: "Tin Tower (8F)"     },
        ...
        mtmortar_r42: {
			...
			mortarwater_bonus:		{x: 312, y: 288,                                 name: "Mortar Entry (Water)" },
		...
		mtmortarback: {
			...
			midstairs:		{x: 66,  y: 255, name: "Mortar Back (Top)" },
			leftstairs:		{x: 73,  y: 565, name: "Mortar Back (Bot)" },
			leftdoor:		{x: 167, y: 712, name: "Mortar Back (Bot)" },
			centerdoor:		{x: 304, y: 744, name: "Mortar Back (Bot)" },
			rightdoor:		{x: 455, y: 712, name: "Mortar Back (Bot)" },
        ...
        lighthouse: {
			f1_land:      {x: 272, y: 812,	corridor: "f1_land",	name: "Lighthouse (F1)"  },
			f1_entrance:  {x: 172, y: 850,							name: "Lighthouse (F1)"  },
			f1_stairs:    {x: 60,  y: 812,							name: "Lighthouse (F1)"  },
			f2_entrance:  {x: 60,  y: 510,							name: "Lighthouse (F2)"  },
			f2_land:      {x: 272, y: 430,	corridor: "f2_land",	name: "Lighthouse (F2)"  },
			f2_hole:      {x: 272, y: 546,							name: "Lighthouse (F2)"  },
			f2_stairs:    {x: 84,  y: 327,							name: "Lighthouse (F2)"  },
			f3_entrance:  {x: 87,  y: 95, 							name: "Lighthouse (F3)"  },
			f3_land:      {x: 271, y: 150,	corridor: "f3_land",	name: "Lighthouse (F3)"  },
			f3_hole:      {x: 271, y: 209,							name: "Lighthouse (F3)"  },
			f3_stairs:    {x: 215, y: 23, 							name: "Lighthouse (F3)"  },
			f3_stairs_drop:{x: 164, y: 40, corridor: "f3_stairs_drop",	name: "Lighthouse (F3) Drop"  },
			f3_stairs_iso:{x: 164, y: 80, 							name: "Lighthouse (F3) Drop"  },
			f4_entrance:  {x: 344, y: 653,							name: "Lighthouse (F4)"  },
			f4_land:      {x: 594, y: 716,	corridor: "f4_land",	name: "Lighthouse (F4)"  },
			...
			f5_land:      {x: 594, y: 390,	corridor: "f5_land",	name: "Lighthouse (F5)"  },
...
//        },
        whirlislands: {
			...
			surf_left:               {x: 129, y: 740, corridor: "surf_right", name: "Whirl (Surf Corridor)" },
			surf_right:              {x: 355, y: 740, corridor: "surf_left",  name: "Whirl (Surf Corridor)" },
		...
		rockethq: {
			rocket_store_door:		{x: 48, 		y: 96,		corridor: "rocket_store_down",			name: "Mahogany Shop"  },
			rocket_store_down:		{x: 96, 		y: 48,		corridor: "rocket_store_door",			name: "Mahogany Shop"  },
			rocket_b1f_up:			{x: 448,		y: 16, 		corridor: "rocket_b1f_down",			name: "Team Rocket HQ (B1F)"  },
			rocket_b1f_down:		{x: 48, 		y: 192,		corridor: "rocket_b1f_up",				name: "Team Rocket HQ (B1F)"  },
			rocket_b2f_bot_up:		{x: 48, 		y: 432,		corridor: "rocket_b2f_bot_down",		name: "Team Rocket HQ (B2F)"  },
			rocket_b2f_bot_down:	{x: 448,		y: 432,		corridor: "rocket_b2f_bot_up",			name: "Team Rocket HQ (B2F)"  },
			rocket_b2f_top_left:	{x: 48, 		y: 264,		corridor: "rocket_b2f_top_right",		name: "Team Rocket HQ (B2F)"  },
			rocket_b2f_top_right:	{x: 448,		y: 264,		corridor: "rocket_b2f_top_left",		name: "Team Rocket HQ (B2F)"  },
			rocket_b3f_main_top:	{x: 448,		y: 512,		corridor: "rocket_b3f_main_bot",		name: "Team Rocket HQ (B3F)"  },
			rocket_b3f_main_bot:	{x: 448,		y: 688,		corridor: "rocket_b3f_main_top",		name: "Team Rocket HQ (B3F)"  },
			rocket_b3f_off_top:		{x: 48, 		y: 512,		corridor: "rocket_b3f_off_bot",			name: "Team Rocket HQ (B3F)"  },
			rocket_b3f_off_bot:		{x: 48, 		y: 560,		corridor: "rocket_b3f_off_top",			name: "Team Rocket HQ (B3F)"  },
		},
		icepath1: {
		...
		icepath2: {
			...
			fall_nw:	{x: 80, y: 80, corridor: "fall_nw",   name: "Ice Path (Fall)" },
			fall_ne:	{x: 240, y: 80,  corridor: "fall_ne",  name: "Ice Path (Fall)" },
			fall_sw:	{x: 80, y: 240, corridor: "fall_sw",   name: "Ice Path (Fall)" },
			fall_se:	{x: 240, y: 240,  corridor: "fall_se",  name: "Ice Path (Fall)" },
		...
		sabrina: {
            nw_nw:				{x: 24,		y: 56,	name:	"Saffron Gym (NW)"},
            nw_ne:				{x: 88,		y: 56,	name:	"Saffron Gym (NW)"},
             n_nw:				{x: 152,	y: 56,	name:	"Saffron Gym (N)"},
             n_ne:				{x: 184,	y: 56,	name:	"Saffron Gym (N)"},
            ne_nw:				{x: 248,	y: 56,	name:	"Saffron Gym (NE)"},
            ne_ne:				{x: 312,	y: 56,	name:	"Saffron Gym (NE)"},
            nw_sw:				{x: 24,		y: 88,	name:	"Saffron Gym (NW)"},
            nw_se:				{x: 88,		y: 88,	name:	"Saffron Gym (NW)"},
             n_sw:				{x: 152,	y: 88,	name:	"Saffron Gym (N)"},
             n_se:				{x: 184,	y: 88,	name:	"Saffron Gym (N)"},
            ne_sw:				{x: 248,	y: 88,	name:	"Saffron Gym (NE)"},
            ne_se:				{x: 312,	y: 88,	name:	"Saffron Gym (NE)"},
			
            w_nw:				{x: 24,		y: 152,	name:	"Saffron Gym (W)"},
            w_ne:				{x: 88,		y: 152,	name:	"Saffron Gym (W)"},
            e_nw:				{x: 248,	y: 152,	name:	"Saffron Gym (E)"},
            e_ne:				{x: 312,	y: 152,	name:	"Saffron Gym (E)"},
            w_sw:				{x: 24,		y: 184,	name:	"Saffron Gym (W)"},
            w_se:				{x: 88,		y: 184,	name:	"Saffron Gym (W)"},
            e_sw:				{x: 248,	y: 184,	name:	"Saffron Gym (E)"},
            e_se:				{x: 312,	y: 184,	name:	"Saffron Gym (E)"},
			
            sw_nw:				{x: 24,		y: 248,	name:	"Saffron Gym (SW)"},
            sw_ne:				{x: 88,		y: 248,	name:	"Saffron Gym (SW)"},
            se_nw:				{x: 248,	y: 248,	name:	"Saffron Gym (SE)"},
            se_ne:				{x: 312,	y: 248,	name:	"Saffron Gym (SE)"},
            sw_sw:				{x: 24,		y: 280,	name:	"Saffron Gym (SW)"},
            sw_se:				{x: 88,		y: 280,	name:	"Saffron Gym (SW)"},
            se_sw:				{x: 248,	y: 280,	name:	"Saffron Gym (SE)"},
            se_se:				{x: 312,	y: 280,	name:	"Saffron Gym (SE)"},
		},
		blackthorngym: {
			bcg_1f_door:	{x: 80, y: 264, 							name: "Blackthorn Gym (1F)" },
			bcg_1f_left:	{x: 24, y: 120,  							name: "Blackthorn Gym (1F)" },
			bcg_1f_right:	{x: 120, y: 152,							name: "Blackthorn Gym (1F)"  },
			bcg_1f_lleft:	{x: 40, y: 104, corridor: "bcg_1f_lleft",	name: "Blackthorn Gym (1F)"  },
			bcg_1f_lright:	{x: 120, y: 104, corridor: "bcg_1f_lright",	name: "Blackthorn Gym (1F)"  },
			bcg_1f_lbot:	{x: 120, y: 120, corridor: "bcg_1f_lbot",	name: "Blackthorn Gym (1F)"  },
			bcg_2f_dleft:	{x: 216, y: 88, 							name: "Blackthorn Gym (2F)"  },
			bcg_2f_dright:	{x: 312, y: 56, 							name: "Blackthorn Gym (2F)"  },
			bcg_2f_dbot:	{x: 312, y: 120, 							name: "Blackthorn Gym (2F)"  },
			bcg_2f_left:	{x: 200, y: 120, corridor: "bcg_2f_right",	name: "Blackthorn Gym (2F)"  },
			bcg_2f_right:	{x: 296, y: 152, corridor: "bcg_2f_left",	name: "Blackthorn Gym (2F)"  },
		},
        victoryroad_reception: {
			...
			roadf2_land:     {x: 30,  y: 30, corridor: "roadf2_land", name: "Victory Road (2F)" },
		...
		celadonstore: {
			...
			f1_el:		{x: 64,		y: 316, name: "Celadon Store" },
			f2_down:	{x: 252,	y: 134, name: "Celadon Store" },
			f2_up:		{x: 204,	y: 176, name: "Celadon Store" },
			f2_el:		{x: 64,		y: 176, name: "Celadon Store" },
			f3_up:		{x: 252,	y: -5,  name: "Celadon Store" },
			f3_down:	{x: 204,	y: 40,  name: "Celadon Store" },
			f3_el:		{x: 64,		y: 40,  name: "Celadon Store" },
			f4_down:	{x: 520,	y: 270, name: "Celadon Store" },
			f4_up:		{x: 470,	y: 316, name: "Celadon Store" },
			f4_el:		{x: 332,	y: 316, name: "Celadon Store" },
        ...
        celadonelevator: {
			cds_el_1f:	{x: 48,		y: 72, name: "Celadon Elev. (1F)" },
			cds_el_2f:	{x: 144,	y: 72, name: "Celadon Elev. (2F)" },
			cds_el_3f:	{x: 48,		y: 168, name: "Celadon Elev. (3F)" },
			cds_el_4f:	{x: 144,	y: 168, name: "Celadon Elev. (4F)" },
			cds_el_5f:	{x: 48,		y: 264, name: "Celadon Elev. (5F)" },
			cds_el_6f:	{x: 144,	y: 264, name: "Celadon Elev. (6F)" },
        },
		rocktunnel: {
			...
			f1_other_north:  {x: 77, y: 49, corridor: "f1_other_south",  name: "Rock Tunnel (noitem)" },
			f1_other_south:  {x: 202, y: 154, corridor: "f1_other_north",  name: "Rock Tunnel (noitem)" },
    ...
    marks: [
        [["unknown",		0], ["corridor",		0], ["dead_end",	 null], ["event",			0], ["center",			0], ["mart",			0], ["one_way",		 null], ["normal",			0]],
    ...
    progress: [
        ...
        [["c_will",			0], ["c_koga",			0], ["c_bruno",			0], ["c_karen",			0], ["c_player",		0], ["c_elm",			0], ["c_mrpkmn",		0], ["c_oak",			0]],
        [["c_lance",		0], ["c_red",			0], ["c_dex",			0], ["c_rival",			0], ["c_rockets",		0], ["c_unown_goal",	0], ["",		undefined], ["",		undefined]],
        [["hm_cut",			0], ["hm_fly",			0], ["hm_surf",			0], ["hm_strength",		0], ["hm_flash",		0], ["hm_whirlpool",	0], ["hm_waterfall",	0], ["hm_rocksmash",	0]],
        [["pokegear",		0], ["radio_card",		0], ["expansion_card",	0], ["squirt_bottle",	0], ["secret_potion",	0], ["card_key",		0], ["pass",			0], ["clear_bell",		0]],
        [["pokedex",		0], ["bike",			0], ["machine_part",	0], ["coin_case",		0], ["lost_item",		0], ["old_rod",			0], ["good_rod",		0], ["super_rod",		0]],
        //[["blue_card",		0], ["red_scale",		0], ["basement_key",	0], ["mystery_egg",		0], ["ss_ticket",		0], ["itemfinder",		0], ["rainbow_wing",	0], ["silver_wing",		0]],
    ],
	modifiers: [
