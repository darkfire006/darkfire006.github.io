let crystal = {
    ...
    warps: {
        ...
        goldenrodelevator: {
			gds_el_1f:	{x: 48,		y: 72, name: "Goldenrod Elevator (1F)" },
			gds_el_2f:	{x: 144,	y: 72, name: "Goldenrod Elevator (2F)" },
			gds_el_3f:	{x: 240,	y: 72, name: "Goldenrod Elevator (3F)" },
			gds_el_4f:	{x: 48,		y: 168, name: "Goldenrod Elevator (4F)" },
			gds_el_5f:	{x: 144,	y: 168, name: "Goldenrod Elevator (5F)" },
			gds_el_6f:	{x: 240,	y: 168, name: "Goldenrod Elevator (6F)" },
			gds_el_b1f:	{x: 144,	y: 264, name: "Goldenrod Elevator (B1F)" },
        },
        underground: {
			top:					{x: 31,  y: 72                                                   },
			...
			basement_director_up:	{x: 252, y: 204, corridor: "basement_director_door",	name: "Basement" },
			basement_director_door:	{x: 252, y: 344, corridor: "basement_director_up",		name: "Basement" },
        },
        radiotower: {
...
//        },
		...
		sabrina: {
            nw_nw:				{x: 24,		y: 56,	name:	"Saffron Gym (North West)"},
            nw_ne:				{x: 88,		y: 56,	name:	"Saffron Gym (North West)"},
             n_nw:				{x: 152,	y: 56,	name:	"Saffron Gym (North)"},
             n_ne:				{x: 184,	y: 56,	name:	"Saffron Gym (North)"},
            ne_nw:				{x: 248,	y: 56,	name:	"Saffron Gym (North East)"},
            ne_ne:				{x: 312,	y: 56,	name:	"Saffron Gym (North East)"},
            nw_sw:				{x: 24,		y: 88,	name:	"Saffron Gym (North West)"},
            nw_se:				{x: 88,		y: 88,	name:	"Saffron Gym (North West)"},
             n_sw:				{x: 152,	y: 88,	name:	"Saffron Gym (North)"},
             n_se:				{x: 184,	y: 88,	name:	"Saffron Gym (North)"},
            ne_sw:				{x: 248,	y: 88,	name:	"Saffron Gym (North East)"},
            ne_se:				{x: 312,	y: 88,	name:	"Saffron Gym (North East)"},
			
            w_nw:				{x: 24,		y: 152,	name:	"Saffron Gym (West)"},
            w_ne:				{x: 88,		y: 152,	name:	"Saffron Gym (West)"},
            e_nw:				{x: 248,	y: 152,	name:	"Saffron Gym (East)"},
            e_ne:				{x: 312,	y: 152,	name:	"Saffron Gym (East)"},
            w_sw:				{x: 24,		y: 184,	name:	"Saffron Gym (West)"},
            w_se:				{x: 88,		y: 184,	name:	"Saffron Gym (West)"},
            e_sw:				{x: 248,	y: 184,	name:	"Saffron Gym (East)"},
            e_se:				{x: 312,	y: 184,	name:	"Saffron Gym (East)"},
			
            sw_nw:				{x: 24,		y: 248,	name:	"Saffron Gym (South West)"},
            sw_ne:				{x: 88,		y: 248,	name:	"Saffron Gym (South West)"},
            se_nw:				{x: 248,	y: 248,	name:	"Saffron Gym (South East)"},
            se_ne:				{x: 312,	y: 248,	name:	"Saffron Gym (South East)"},
            sw_sw:				{x: 24,		y: 280,	name:	"Saffron Gym (South West)"},
            sw_se:				{x: 88,		y: 280,	name:	"Saffron Gym (South West)"},
            se_sw:				{x: 248,	y: 280,	name:	"Saffron Gym (South East)"},
            se_se:				{x: 312,	y: 280,	name:	"Saffron Gym (South East)"},
		},
		blackthorngym: {
    ...
    marks: [
		...
		[["c_magikarp",		0], ["c_bills_grandpa",	0], ["c_kurt",			0], ["c_daycare",		0], ["dratini",			0], ["burned_tower",	0], ["c_legendary",		0]]
    ],
    progress: [
        ...
        [["c_will",			0], ["c_koga",			0], ["c_bruno",			0], ["c_karen",			0], ["",		undefined], ["c_elm",			0], ["c_mrpkmn",		0], ["c_oak",			0]],
        ...
        [["pokegear",		0], ["radio_card",		0], ["expansion_card",	0], ["squirt_bottle",	0], ["secret_potion",	0], ["card_key",		0], ["pass",			0], ["lost_item",		0]],
        [["pokedex",		0], ["bike",			0], ["machine_part",	0], ["coin_case",		0], ["old_rod",			0], ["good_rod",		0], ["super_rod",		0], ["itemfinder",		0]],
        //[["blue_card",		0], ["red_scale",		0], ["basement_key",	0], ["mystery_egg",		0], ["ss_ticket",		0], ["clear_bell",		0], ["rainbow_wing",	0], ["silver_wing",		0]],
    ],
	modifiers: [
